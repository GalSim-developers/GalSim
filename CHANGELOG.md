...
- Added new methods of the image class to simulate detector effects: nonlinearity and
  reciprocity failure (#552), inter-pixel capacitance (#555), and image quantization (#558).
