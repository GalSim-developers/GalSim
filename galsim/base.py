...
are collectively known as GSObjects.  They include both simple objects like the galsim.Gaussian, a 2d 
Gaussian intensity profile, and compound objects like the galsim.Add and galsim.Convolve, which 
...
class GSObject(object):
    ...
    def drawShoot(self, image=None, dx=None, gain=1., wmult=1., normalization="flux",
        ...
        If an image is supplied, then the photons generated by the drawShoot() method will be binned
        into it.  The input image will be cleared before drawing in the photons by default, unless
        the keyword add_to_image is set to True.  Scale and location of the image pixels will not be
        altered.
