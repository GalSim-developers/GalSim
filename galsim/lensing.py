...
class PowerSpectrum(object):
    ...
    initialization or later on with the method set_power_functions.  Note that the power spectra can
    be ones provided in galsim.lensing (currently just a few simple power laws), or they can be
    ...
    @param[in] E_power_function A function or other callable that accepts a grid of |k| values, and
                                returns the E-mode power spectrum P_E(|k|).  It should cope happily with
                                |k|=0.  The function should return the power spectrum desired in the
                                E (gradient) mode of the image.
    @param[in] B_power_function A function or other callable that accepts a grid of |k| values, and
                                returns the B-mode power spectrum P_B(|k|).  It should cope happily with
                                |k|=0.  The function should return the power spectrum desired in the
                                B (curl) mode of the image.
...
class PowerSpectrumRealizer(object):
    ...
    @param[in] E_power_function A function or other callable that can take an array of k values
                                and return a power.  It should cope happily with k=0.  The function
                                should return the power spectrum desired in the E (gradient) mode of
                                the image.
    @param[in] B_power_function A function or other callable that can take an array of k values
                                and return a power.  It should cope happily with k=0.  The function
                                should return the power spectrum desired in the B (curl) mode of the
                                image.
    """
