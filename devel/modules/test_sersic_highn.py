...
print 'Writing drawn, shot, and diff image to files: ',file_draw_ground, file_shoot_ground, file_diff_ground
...
print 'Writing drawn, shot, and diff image to files: ',file_draw_space, file_shoot_space, file_diff_space
