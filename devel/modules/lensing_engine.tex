...
$2.36\times 10^{-7}$.  These are all $\sim 5$\% below my naive calculation.
...
finite-gridding effect.  Rather than pursuing this question further,
we investigate it in the context of the full $P(k)$ in the next
section.
