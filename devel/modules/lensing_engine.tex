...
probed by our grid.  Based on this figure, it seems plausible that the
power spectra that we're producing are just fine.  However, it also
...
\textbf{Need to test robustness to grid spacing and size.}
