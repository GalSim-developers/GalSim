...
that I expected numerically.  In terms of the difference between the
grids, we expect the result to go down by a factor of 4 in the last
grid, since $\sigma^2$ is larger.  This did not happen.
