...
def testShootVsFfft():
    ...
    hsm_shoot = galsim.hsm.EstimateShear(gal_image=image_gal_shoot,PSF_image=image_psf_shoot,strict=False,shear_est='LINEAR')
    hsm_fft   = galsim.hsm.EstimateShear(gal_image=image_gal_fft,PSF_image=image_psf_shoot,strict=False,shear_est='LINEAR')
