...
Replace pixels:
The other object pixels are replaced with a region of noise map identical to
the region of other object. This is done so as to preserve noise correlations.
