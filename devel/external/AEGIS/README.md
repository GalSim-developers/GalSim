...
The final products are similar to the COSMOS Real Galaxy training sample and can be downloadef from this [link](http://great3.jb.man.ac.uk/leaderboard/data/public/AEGIS_training_sample.tar.gz).
