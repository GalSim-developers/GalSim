...
def test_output_generation_basic():
    ...
    # Then generate a 2nd level CorrFunc from this generated noise field: should be approximately
    # equal to the input
    ...
    np.testing.assert_array_almost_equal(
        outim1.array, outim2.array, decimal=1, # only matches to 1dp, and variance always seems
                                               # *larger* in the 2nd level correlation function, is
                                               # there perhaps a theorem about this?
        err_msg="Generated noise field (basic) does not match input correlation properties to 1dp.")
