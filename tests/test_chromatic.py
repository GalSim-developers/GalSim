...
bulge_SED = bulge_SED.createWithFluxDensity(wavelength=500.0, target_flux_density=0.3)

disk_SED = galsim.SED(os.path.join(datapath, 'CWW_Sbc_ext.sed'), wave_type='ang')
disk_SED = disk_SED.createWithFluxDensity(wavelength=500.0, target_flux_density=0.3)
...
def test_chromatic_flux():
    ...
    target_flux = 2.63
    bulge_SED2 = bulge_SED.createWithFlux(bandpass, target_flux)
