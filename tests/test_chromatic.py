...
if __name__ == "__main__":
    ...
    #check flux for a few filters
    #test a profile with two inseperable components?  two PSFs maybe?

    #most critical are flux and moment shifts.  keep only these when switching integrators?
    #next do add
