...
whether this step can be safely omitted to speed things up.
...
turn is governed by the resolution of the telescope, as explained in the previous section. Time
...
were never intended for public release. Two code that are publically available are
...
\item \arroyo\ -- http://cfao.ucolick.org/software/arroyo.php
  ...
  library, which goes well beyond what we need in \galsim.
...
\item \laopack\ --
  ...
  A collection of IDL routines for adapative optics, including the generation of Kolmogorov/von
...
\item It would interesting to learn more about the new method developed by LSST.
\end{itemize}
