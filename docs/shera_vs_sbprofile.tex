...
Due to the aforementioned rules about ratios of output to input
  pixel scale, and method of dealing with target PSFs, \shera\ has rather
...
exactly like the real galaxies on the sky. Rather, GalSim must draw
