    ...
    struct PySBProfile {
        ...
        static void wrap() {
            ...
            pySBProfile
                ...
                .def("draw", (ImageView<float> (SBProfile::*)(double, double, int) 
                              const)&SBProfile::draw,
                     (bp::arg("dx")=0., bp::arg("gain")=1., bp::arg("wmult")=1),
