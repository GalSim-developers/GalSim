...
#    To run on master, uncomment the next four lines, then comment the next line as indicated
...
#    orig_gal_img = real_galaxy.original_image.draw(dx=pixel_scale) # Comment out this line to run on master
