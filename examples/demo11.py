...
This function is stored within the GalSim repository as a FITS file, and this demo points to the
relative location of that file.

Therefore THIS DEMO WILL NOT WORK UNLESS it is run from its original location in the examples/
directory of the GalSim repository.
