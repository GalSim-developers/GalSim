...
def main(argv):
    ...
    optics = galsim.OpticalPSF(
        ...
        defocus = 0.1 / numpy.sqrt(3.), 
        astig1 = 0.3 / numpy.sqrt(6.), astig2 = -0.2 / numpy.sqrt(6.), 
        coma1 = 0.2 / numpy.sqrt(8.), coma2 = 0.1 / numpy.sqrt(8.),
        spher = -0.3 / numpy.sqrt(5.), gsparams=gsparams)
