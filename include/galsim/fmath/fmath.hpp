...
#define HAS_FMATH
	...
	#define __GNUC_PREREQ(major, minor) ((((__GNUC__) << 16) + (__GNUC_MINOR__)) >= (((major) << 16) + (minor)))
        ...
        // As far as I can tell, this has been available since at least clang version 3, but
        // clange oftem masquerades as gcc 4.2, so the normal gcc check doesn't get this right.
        #include <x86intrin.h>
