...
namespace galsim {
	...
	//
        ...
        virtual double centroidX() const =0; ///<Centroid shift of SBProfile.
        virtual double centroidY() const =0; ///<Centroid shift of SBProfile.

        /// Get centroid shift of SBProfile
